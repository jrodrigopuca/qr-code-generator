function getBetterQR(text){
    ...
    return {"version":version, "lvlCorrection": lvlCorrection, "length": len};
}
...
class QR {
    ...
    mask() {
        const fmask = [
            {"func":(r,c)=>{return (r+c)%2===0}},
            {"func":(r,c)=>{return r%2===0}},
            {"func":(r,c)=>{return c%3===0}},
            {"func":(r,c)=>{return (r+c)%3===0}},
            {"func":(r,c)=>{return (Math.floor(r/2)+Math.floor(c/3))%2===0}},
            {"func":(r,c)=>{return (((r*c)%2)+((r*c)%3))===0}},
            {"func":(r,c)=>{return (((r*c)%2)+((r*c)%3))%2===0}},
            {"func":(r,c)=>{return (((r+c)%2)+((r*c)%3))%2===0}},
        ]
        
        const f= fmask[this.maskNumber];
    ...
    formatInfo() {
        ...
        if (this.version >= 7) {
            ...
            for (let i = 0; i < 6; i++) {
                // abajo
                this.board[this.d - 11][i] = Number(info[j++]) == 1 ? 4 : 2;
                this.board[this.d - 10][i] = Number(info[j++]) == 1 ? 4 : 2;
                this.board[this.d - 9][i] = Number(info[j++]) == 1 ? 4 : 2;

                // arriba
                this.board[i][this.d - 11] = Number(info[k++]) == 1 ? 4 : 2;
                this.board[i][this.d - 10] = Number(info[k++]) == 1 ? 4 : 2;
                this.board[i][this.d - 9] = Number(info[k++]) == 1 ? 4 : 2;
